...
export const setContext = (c: EmitContext<EmitterOptions>): void => { context = c; };

export const reportDiagnostic = (diagnostic: Pick<Diagnostic, "code" | "message" | "severity">): void => {
